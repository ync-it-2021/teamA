		...
		<div id="page-member-join-step2" class="section-member pc-width">
			...
			<form name="frmReg" action="#" method="post">
				<input type="hidden" name="coupon" value=""> <input
					...
					type="hidden" name="certNum" value="">
				<div class="contents-wrapper member-info-form">
					<h2 class="page-sub-title kr">개인정보 입력</h2>
					<div class="page-content-desc">Gift to pet 에 오신것을 환영합니다. 필수입력 사항입니다.
					</div>

					<table class="item-table type1 input-form">
						<tr>
							<th>아이디</th>
							<td><input type="text" name="id" class="input2 member-id"
								...
								maxlength="20" /> <span class="btn-type1 findid"
								style="cursor: pointer">중복확인</span> <span class="form-comment">※
									6~15자리의 영문 숫자를 조합하여 만들어 주세요.</span></td>
						</tr>
						<tr>
							<th>비밀번호</th>
						...
						<th>도로명 주소</th>
						<td><input type="text" name="" readOnly maxlength="10"
							class="input1" id="sample3_postcode" /> <span
				...
				<div class="contents-wrapper member-info-form">
					...
					<div class="action-buttons" name="sub1" id="sub1">
						<span class="ok type2" onClick="history.go(-1);;"
							style="cursor: pointer">취소</span>
