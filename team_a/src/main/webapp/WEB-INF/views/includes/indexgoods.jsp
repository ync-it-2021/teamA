...
<body>
			...
			<div class="contents-wrapper best-seller-wrapper pc-width">
				<div style="text-align:center;  width:100%; margin-bottom: -35px; margin-top:50px" id="best_seller_tit">
					<img src="../resources/images/main_title_02.png">
				</div>
					...
					<div class="page-block">
						<ul>
							...
							<li class="item" style="cursor:pointer;"
								...
								<img class="item-image" src="../resources/images/p1571_20210901pm33611_1.jpg"
									alt="MDs Choice 3" />
								<p class="item-title">프로도기</p>
					...
					<div class="page-block">
						<ul>
							<li class="item" style="cursor:pointer;"
								...
								<img class="item-image" src="../resources/images/p1551_20201231am113249_1.jpg"
									alt="MDs Choice 4" />
					...
					<div class="page-block">
						<ul>
							<li class="item" style="cursor:pointer;"
								...
								<img class="item-image" src="../resources/images/p1612_20210622am105512_1.jpg"
									alt="MDs Choice 6" />
								<p class="item-title">디그앤롤</p>
							...
							<li class="item" style="cursor:pointer;"
								...
								<img class="item-image" src="../resources/images/p1319_20210905pm114143_1.jpg"
									alt="MDs Choice 7" />
					...
					<div class="page-block">
						<ul>
							<li class="item" style="cursor:pointer;"
								...
								<img class="item-image" src="../resources/images/p1035_20210905pm114331_1.jpg"
									alt="MDs Choice 8" />
								<p class="item-title">마스</p>
							...
							<li class="item" style="cursor:pointer;"
								...
								<img class="item-image" src="../resources/images/p1641_20210929am82337_1.jpg"
									alt="MDs Choice 9" />
					...
					<div class="page-block">
						<ul>
							<li class="item" style="cursor:pointer;"
								...
								<img class="item-image" src="../resources/images/p1642_20210929am82428_1.jpg"
									alt="MDs Choice 10" />
								<p class="item-title">에그풀</p>
							...
							<li class="item" style="cursor:pointer;"
								...
								<img class="item-image" src="../resources/images/p1637_20210929am81938_1.jpg"
									alt="MDs Choice 11" />
								<p class="item-title">에그풀</p>
			...
			<div id="best-items" style="margin-bottom:50px;">
				<div class="pc-width">
					...
					<div class="category-item-wrapper">
						...
						<c:forEach var="i" begin="0" end="${fn:length(best)-2}" step="2">
							<div class="page-block">
									<ul>
										<li class="item"
											onclick="location.href = '/prodect/get/prd=${best[i].prd_idx}'"
											style="cursor:pointer;">
											<img class="item-image" src="/resources/upload/${best[i].prd_img1}">
<!-- 											<p class="item-title">
												<script language="javascript">view_name("view_brand", "20", "write")</script>
											</p> -->
											<p class="item-description"><c:out value="${best[i].prd_name}"/></p>
										</li>
										
										<li class="item"
											onclick="location.href = '/prodect/get/prd=${best[i+1].prd_idx}'"
											style="cursor:pointer;">
											<img class="item-image" src="/resources/upload/${best[i+1].prd_img1}">
									<!-- 		<p class="item-title">
												<script language="javascript">view_name("view_brand", "20", "write")</script>
											</p> -->
											<p class="item-description"><c:out value="${best[i+1].prd_name}"/></p>
										</li>
									</ul>
								</div>
						</c:forEach>
