...
<div class="row">
	<div class="col-lg-12">
		<h1 class="page-header">1대1 문의</h1>
	</div>
	<!-- /.col-lg-12 -->
</div>
<!-- /.row -->
			...
			<div class="panel-body">
				...
				<div class='row'>
					<div class="col-lg-12">
						...
						<form id='searchForm' action="admin/oi/list" method='get'>
							<select name='type'>
								<option value=""
				...
				<!-- 페이징 Form 시작 -->
				<form id='actionForm' action="/admin/oi/list" method='get'>
...
<script type="text/javascript">
	$(document).ready(function() {
		...
		$(".move").on("click",function(e) {
			e.preventDefault();
			actionForm.append("<input type='hidden' name='oi' value='" + $(this).attr("href")	+ "'>");
			actionForm.attr("action", "/admin/oi/get");
			actionForm.submit();
		});
